...
public class MealsUtil {
    ...
    public static final List<Meal> meals2 = Arrays.asList(
            new Meal(LocalDateTime.of(2021, Month.JANUARY, 30, 10, 0), "User2 Завтрак", 501),
            new Meal(LocalDateTime.of(2021, Month.JANUARY, 30, 13, 0), "User2 Обед", 1001),
            new Meal(LocalDateTime.of(2021, Month.JANUARY, 30, 20, 0), "User2 Ужин", 501),
            new Meal(LocalDateTime.of(2021, Month.JANUARY, 31, 0, 0), "User2 Еда на граничное значение", 101),
            new Meal(LocalDateTime.of(2021, Month.JANUARY, 31, 10, 0), "User2 Завтрак", 1001),
            new Meal(LocalDateTime.of(2021, Month.JANUARY, 31, 13, 0), "User2 Обед", 501),
            new Meal(LocalDateTime.of(2021, Month.JANUARY, 31, 20, 0), "User2 Ужин", 411)
    );
