...
public class MealsUtil {
    ...
    public static final List<Meal> meals = Arrays.asList(
            ...
            new Meal(LocalDateTime.of(2021, Month.JANUARY, 30, 10, 0), "Завтрак", 501, 2),
            new Meal(LocalDateTime.of(2021, Month.JANUARY, 30, 13, 0), "Обед", 1001, 2),
            new Meal(LocalDateTime.of(2021, Month.JANUARY, 30, 20, 0), "Ужин", 501, 2),
            new Meal(LocalDateTime.of(2021, Month.JANUARY, 31, 0, 0), "Еда на граничное значение", 101, 2),
            new Meal(LocalDateTime.of(2021, Month.JANUARY, 31, 10, 0), "Завтрак", 1001, 2),
            new Meal(LocalDateTime.of(2021, Month.JANUARY, 31, 13, 0), "Обед", 501, 2),
            new Meal(LocalDateTime.of(2021, Month.JANUARY, 31, 20, 0), "Ужин", 411, 2)
    );
