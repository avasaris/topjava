...
public class JdbcMealRepository implements MealRepository {
    ...
    public List<Meal> getBetweenHalfOpen(LocalDateTime startDateTime, LocalDateTime endDateTime, int userId) {
        log.info("getBetweenHalfOpen startDateTime {} endDateTime {} userid {}", startDateTime, endDateTime, userId);
        return jdbcTemplate.query("SELECT * FROM meals WHERE user_id=? AND date_time::date >=? AND date_time::date <? ORDER BY date_time DESC",
                ROW_MAPPER,
                userId,
                startDateTime,
                endDateTime);
